...
public class Respawner : MonoBehaviour
{
    ...
    public void Respawn()
    {
        // When a ship is destroyed, play sound.
        var aS = GetComponent<AudioSource>();
        aS.PlayOneShot(GetComponent<Ship>().targetDestroyed);
        ...
        // Align our orientation with the SpawnPoint's orientation, which can be edited in Unity
